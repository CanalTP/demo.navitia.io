...
// FirstLetter 1er depart
var fletter_first_origin = new AutocompleteEngine(
...
fletter_first_origin.setPlaceTypeLabels(itemTypeLabels);
fletter_first_origin.setCallbackFunctions({
    onResult: locateAutocompleteItemOnMap,
    onClick: locateAutocompleteItemOnMap,
    onErase: null
});
fletter_first_origin.setCallbackAttributes({
    markerType: 'origin'
});
fletter_first_origin.bind('meeting_first_origin', 'FLFirstOriginDivId');

// FirstLetter 2e depart
var fletter_second_origin = new AutocompleteEngine(
    '<?php echo config_get('webservice', 'Url', 'CrossDomainNavitia');
           echo request_get('RegionName'); ?>',
    '<?php url_link('autocomplete/get_ajax_html/container'); ?>',
    '<?php url_link('autocomplete/get_ajax_html/item'); ?>'
);
fletter_second_origin.setPlaceTypeLabels(itemTypeLabels);
fletter_second_origin.setCallbackFunctions({
    onResult: locateAutocompleteItemOnMap,
    onClick: locateAutocompleteItemOnMap,
    onErase: null
});
fletter_second_origin.setCallbackAttributes({
    markerType: 'origin'
});
fletter_second_origin.bind('meeting_second_origin', 'FLSecondOriginDivId');

// FirstLetter 3e depart
var fletter_third_origin = new AutocompleteEngine(
    '<?php echo config_get('webservice', 'Url', 'CrossDomainNavitia');
           echo request_get('RegionName'); ?>',
    '<?php url_link('autocomplete/get_ajax_html/container'); ?>',
    '<?php url_link('autocomplete/get_ajax_html/item'); ?>'
);
fletter_third_origin.setPlaceTypeLabels(itemTypeLabels);
fletter_third_origin.setCallbackFunctions({
    onResult: locateAutocompleteItemOnMap,
    onClick: locateAutocompleteItemOnMap,
    onErase: null
});
fletter_third_origin.setCallbackAttributes({
    markerType: 'origin'
});
fletter_third_origin.bind('meeting_third_origin', 'FLThirdOriginDivId');
